        ...
        return args -> {
            ...
            if (productRepository.count() == 0) {
                List<Product> products = Arrays.asList(
                    ...
                    new Product("Dados Metalicos Set", "Accesorios", "Dados", 34.99, null, null, "dados-metalicos-set.jpg", true, 5.0, 156, false, false),
                    ...
                    new Product("Pokemon Paradox Rift", "TCG", "Pokemon", 4.50, null, null, "pokemon paradox rift.jpg", true, 5.0, 567, false, true),
                    new Product("Pokemon Card Sleeve", "Accesorios", "Fundas", 8.99, null, null, "pokemon-card-sleeve.jpg", true, 4.0, 456, false, false),
